...
VALUE WEEKDAY YEAR MID TRIM UPPER LOWER AVERAGEIF CONCATENATE VLOOKUP HLOOKUP ISTEXT NA DATEDIF
SMALL LARGE ADDRESS ISNA""".split())

gen = ["VAE対象一覧", "臨床所見", "VAE-01", "All", "VAE集計", "CLABSI判定", "CLABSI集計",
       "年間集計(VAE)", "年間集計(CLABSI)", "上半期 (CLABSI)"]
